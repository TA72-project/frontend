...
export const createPatient = async (fname: string, lname: string, mail: string, phone: string, password: string, address: string) => {
    try {
...
export const updatePatient = async (id: number, idUser: number, idAddress: number) => {
    try {
